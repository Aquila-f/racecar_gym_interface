...
class VecVideoRecorder(VecEnvWrapper):
    ...
    def __init__(
        ...
        # assert self.env.render_mode == "rgb_array" or "rgb_array" in self.env.render_mode, f"The render_mode must be 'rgb_array', not {self.env.render_mode}"

        #
        try:
            if self.env.render_mode == "rgb_array" or "rgb_array" in self.env.render_mode:
                warnings.warn(f"The render_mode must be 'rgb_array', not {self.env.render_mode}")
